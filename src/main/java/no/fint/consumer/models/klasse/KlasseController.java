...
public class KlasseController {
    ...
    public KlasseResources getKlasse(
        ...
        return linker.toResources(klasse);
    }


    @GetMapping("/id/{id:.+}")
    public KlasseResource getKlasseById(
        ...
        if (cacheService != null) {
            ...
            Optional<KlasseResource> klasse = cacheService.getKlasseById(orgId, id);
            ...
            return linker.toResource(klasse);
        }    
    }
